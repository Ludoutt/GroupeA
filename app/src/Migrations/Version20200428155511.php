 ...
 */
final class Version20200428155511 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE feature ADD category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_1FD7756612469DE2 ON feature');
        $this->addSql('ALTER TABLE feature DROP category_id');
    }
}
